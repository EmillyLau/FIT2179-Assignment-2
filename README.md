...
#Section Idiom Dataset
1 Intro 🗺️ Choropleth map — losses by state DOSM
2 Intro 🗺️ Symbol map — flood events sized by people affected EM-DAT
...
10 Showpiece ⭐ Radial — vulnerability score per state All 3 combined 